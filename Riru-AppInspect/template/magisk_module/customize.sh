...
extract "$ZIPFILE" 'system/lib64/libre_server.so' "$MODPATH"
extract "$ZIPFILE" 'system/lib/libre_server.so' "$MODPATH"

extract "$ZIPFILE" 'system/lib64/libjsu.so' "$MODPATH"
extract "$ZIPFILE" 'system/lib/libjsu.so' "$MODPATH"
