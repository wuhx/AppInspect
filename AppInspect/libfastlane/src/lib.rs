        ...
        android_logger::Config::default()
            ...
            .with_filter(
                android_logger::FilterBuilder::new()
                    ...
                    .parse("debug,tonic_web=info,warp=error,hyper=error,libadb_rs=error,sled=error,lwip_rs::NetIf=error,bandwidth_rs=error,redq_rs=error,lwip_rs=error,h2=error,jni=error")
                    .build(),
            ),
    );
